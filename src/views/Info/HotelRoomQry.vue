                ...
                <el-collapse>
                    ...
                    <div class="input-content">
                        ...
                        <div class="input-info">
                            ...
                            <el-form-item prop="roomArea" style="margin-bottom: 0;vertical-align: middle;">
                            ...
                            <el-collapse>
                                <el-collapse-item>
                                    ...
                                    <div style="width: 100%;padding: 4px 0;">
                                        <el-form-item prop="isnosmk" style="margin-bottom: 10px;vertical-align: middle;line-height: 32px;">
    ...
    export default {
        ...
        data() {
            return {
                ...
                pickerOptions2:{
                    disabledDate : (time) =>{
                        if(this.commonDate && this.commonDate.length>1){
        ...
        methods: {
            ...
            // 预约
            submitForm: function () {
                if (this.dataForm.totalTAmount==null || this.dataForm.totalTAmount == '') {
...
<style scoped>
    ...
    .input-label{
        width: 100px;background: #daf6fa;text-align: center;line-height: 32px;font-size:.9em;color: #14889a;display: table-cell;vertical-align: middle;
    }
    .input-info{
