<template>
    <div class="page-container">
                    ...
                    <el-col :span="24">
                        <el-form-item @mouseleave.native="serch_result_user = false">
                            ...
                            <div class="serch_result" v-show="serch_result_user"
                                 style="position: absolute; z-index: 100;width: 100%;box-sizing: border-box; background: #fff; list-style: none; border: 1px solid #DCDFE6; border-top: 0;">
                                <li v-for="item in user_result" class="serch-list"
                                    @click="filters.createName = item.name">
                                    {{ item.name }}
                                </li>
                            </div>
                        </el-form-item>
        ...
        <kt-table permsEdit="sys:bizPuchs:edit" permsCancel="sys:bizPuchs:cancel" permsConfirm="sys:bizPuchs:confirm"
                  excelManagerConfirm="sys:excelExport:confirm"
                  excelExportBody="sys:bodyExcel:export" :data="pageResult" :columns="columns"
                  @findPage="findPage" @handleEdit="handleEdit" @handleCancel="handleCancel"
                  @handleConfirm="handleConfirm" @exportExcel="exportExcel"
        ...
        <el-dialog :title="operation?$t('action.add'):$t('action.edit')" width="90%" style="margin-top: -120px"
            ...
            <!--&lt;!&ndash;<el-carousel :interval="4000" type="card" height="200px">&ndash;&gt;-->
            <!--&lt;!&ndash;<el-carousel-item>&ndash;&gt;-->
            <!--&lt;!&ndash;<el-image style="width:100%;height:200px" src="https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg"></el-image>&ndash;&gt;-->
            <!--&lt;!&ndash;</el-carousel-item>&ndash;&gt;-->
            ...
            <!--</el-row>-->
            <!--</el-form>-->
            <el-form :model="dataForm" :rules="dataFormRules" ref="dataForm" label-position="left"
                     :inline="true">
                <el-row>
                    <el-col :span="11">
                        <el-row style="width: 100%;text-align: left;display: flex;margin: 0 auto;">
                            <el-col :span="6"
                                    style="padding-top:10px;border-right: 1px solid #e6e6e6;border-bottom: 1px solid #e6e6e6;text-align: center;">
                                <label style="font-size: 16px;color: #212121;">{{$t('order.baseInfo')}}</label>
                            </el-col>
                            <el-col :span="18" style="border-bottom: 1px solid #e6e6e6;">
                                <ul class="hotel-base">
                                    ...
                                    <li style="padding-top: 4px">
                                        ...
                                        <el-popover
                                            ...
                                            trigger="click">
                                            <el-table :data="gridData" height="300px">
                                                <el-table-column width="150" property="priceDate"
                                                                 :label="$t('order.date')"></el-table-column>
                                                <el-table-column width="100" property="sroomPrice"
                                                                 :label="$t('hotel.sRoomPrice')"></el-table-column>
                                            </el-table>
                                            <el-button slot="reference">{{$t('order.detail')}}</el-button>
                                        </el-popover>
                                    </li>
                                    ...
                                    <li style="padding-top: 4px">
                                        <el-row>
                                            <el-col :span="12">
                                                <el-form-item label-width="180px" :label="$t('hotel.adultNum')"
                                                              prop="adultNum"
                                                              style="margin-bottom: 6px;margin-right: 0; ">
                                                    <el-input-number size="mini" v-model="dataForm.adultNum"
                                                                     controls-position="right" disabled
                                                                     :min="0"></el-input-number>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :span="12">
                                                <el-form-item label-width="180px" :label="$t('hotel.childrenNum')"
                                                              prop="childNum"
                                                              style="margin-bottom: 6px;margin-right: 0;">
                                                    <el-input-number v-model="dataForm.childNum"
                                    ...
                                    <li style="display: flex">
                                        <el-row>
                                            <el-col :span="12">
                                                <el-form-item :label="$t('hotel.roomNum')" label-width="180px"
                                                              prop="roomNum" >
                                                    <el-input-number size="mini" v-model="dataForm.roomNum" disabled
                                                                     controls-position="left" :max="dataForm.inventory"
                                                                     :min="0"></el-input-number>
                                                </el-form-item>
                            ...
                            <el-col :span="18" style="border-bottom: 1px solid #e6e6e6;">
                                <ul class="hotel-base">
                                    <li>
                                        <el-row>
                                            <el-col :span="12">
                                                <label style="width: 180px;display: inline-block; ">{{$t('hotel.hotelname')}}</label>
                                            ...
                                            <el-col :span="12">
                                                <label style="width: 180px; display: inline-block;" >{{$t('order.localArea')}}</label>
                                                <input hidden v-model="dataForm.provinceCode"/>
                                                <el-tag>{{resolveRoomTypeName(provinceCode,dataForm.provinceCode)}}</el-tag>
                                                <el-tag>{{resolveRoomTypeName(cityCode,dataForm.cityCode)}}</el-tag>
                                            </el-col>
                                        </el-row>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <el-row>
                                            <el-col :span="12">
                                                <label
                                                    style="display: inline-block;">{{$t('hotel.scheduledays')}}</label>
                                                <el-tag>{{dataForm.scheduledays}}</el-tag>
                                            </el-col>
                                            <el-col :span="12">
                                                <label
                                                    style="display: inline-block;">{{$t('hotel.favorableprice')}}</label>
                        ...
                        <el-row style="width: 100%;text-align: left;display: flex;margin: 0 auto;">
                            ...
                            <el-col :span="18" style="border-bottom: 1px solid #e6e6e6;padding: 0 10px;">
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.iswify==1">
                                    {{$t('hotel.iswify')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isfront==1">
                                    {{$t('hotel.isfront')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isbarrifr==1">
                                    {{$t('hotel.isbarrifr')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isbalcony==1">
                                    {{$t('hotel.isbalcony')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.iskitchen==1">
                                    {{$t('hotel.iskitchen')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.iswindow==1">
                                    {{$t('hotel.iswindow')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isheat==1">
                                    {{$t('hotel.isheat')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isicebox==1">
                                    {{$t('hotel.isicebox')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isiron==1">
                                    {{$t('hotel.isiron')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isnosmk==1">
                                    {{$t('hotel.isnosmk')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.islandscape==1">
                                    {{$t('hotel.islandscape')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isSeaviewRoom==1">
                                    {{$t('hotel.isSeaviewRoom')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isMountainViewRoom==1">
                                    {{$t('hotel.isMountainViewRoom')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isCityViewRoom==1">
                                    {{$t('hotel.isCityViewRoom')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.ishighrise==1">
                                    {{$t('hotel.ishighrise')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.ispark==1">
                                    {{$t('hotel.ispark')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isgym==1">
                                    {{$t('hotel.isgym')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isswmp==1">
                                    {{$t('hotel.isswmp')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isbeach==1">
                                    {{$t('hotel.isbeach')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.ishotsp==1">
                                    {{$t('hotel.ishotsp')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.ischildct==1">
                                    {{$t('hotel.ischildct')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isroomserv==1">
                                    {{$t('hotel.isroomserv')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isknead==1">
                                    {{$t('hotel.isknead')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.islounge==1">
                                    {{$t('hotel.islounge')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.issuper==1">
                                    {{$t('hotel.issuper')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isbus==1">
                                    {{$t('hotel.isbus')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.istrafic==1">
                                    {{$t('hotel.istrafic')}}
                                </el-tag>
                                <el-tag style="margin: 6px" type="success" v-show="dataForm.isrestau==1">
                                    {{$t('hotel.isrestau')}}
                                </el-tag>
                            </el-col>
                        </el-row>
                    ...
                    <el-col :span="11">
                        <el-row style="width: 100%;text-align: left;display: flex;margin: 0 auto;">
                            <el-col :span="6"
                                    style="padding-top:10px;border-right: 1px solid #e6e6e6;text-align: center;">
                            </el-col>
                            <el-col :span="18" align="center">
                                ...
                                <el-row style="border-top: 1px solid #e6e6e6;padding-top:5px;">
                                    <el-col :span="12">
                                        <el-form-item label-width="180px" :label="$t('hotel.representName')"
                                                      prop="pName">
                                            <el-input v-model="dataForm.pName"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="12">
                                        <el-form-item label-width="180px" :label="$t('hotel.passportNo')"
                                                      prop="passport">
                                            <el-input v-model="dataForm.passport"></el-input>
                                        </el-form-item>
                                    </el-col>
                                ...
                                <el-row>
                                    <el-col :span="12">
                                        <el-form-item label-width="180px" :label="$t('hotel.contactEmail')"
                                                      prop="emailAddress">
                                            <el-input v-model="dataForm.emailAddress"></el-input>
                                        </el-form-item>
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label-width="180px" :label="$t('hotel.contactPhone')"
                                                      prop="phone">
                                            <el-input v-model="dataForm.phone"></el-input>
                                        </el-form-item>
                                    </el-col>
                                ...
                                <el-row>
                                    <el-col :span="24" align="left"
                                            style="border-top: 1px solid #e6e6e6;padding-top:5px;margin-bottom: 10px;margin-left: 10px;font-weight: bold;font-style: italic;">
                                        {{$t('hotel.childrenNum')}}
                                    </el-col>
                                </el-row>

                                <el-form-item label-width="180px" :label="$t('hotel.children612')" prop="children612">
                                    <el-input-number v-model="dataForm.children612" controls-position="right"
                                                     style="width: 200px" :min="0"></el-input-number>
                                </el-form-item>
                                <el-form-item label-width="180px" :label="$t('hotel.children46')" prop="children46">
                                    <el-input-number v-model="dataForm.children46" controls-position="right"
                                                     style="width: 200px" :min="0"></el-input-number>
                                </el-form-item>
                                <el-form-item label-width="180px" :label="$t('hotel.children04')" prop="children4">
                                    <el-input-number v-model="dataForm.children4" controls-position="right"
                                                     style="width: 200px" :min="0"></el-input-number>
                                </el-form-item>

                                <el-form-item label-width="180px" :label="$t('hotel.reMark')" prop="reMark">
                                    <el-input type="textarea" style="width: 200px;letter-spacing: 1px" :rows="4"
                                              resize="none" v-model="dataForm.remark"></el-input>
                                </el-form-item>
                                <el-row>
                                    <el-col :span="24"
                                            style="margin-top: 20px;margin-bottom: 20px;padding-top:10px;border-bottom: 1px solid #e6e6e6;text-align: center;border-top: 1px solid #e6e6e6;">

                                        <el-form-item :label="$t('hotel.totalPrice')" label-width="180px"
                                                      prop="totalPrice">
                                            <span
                                                style="width: 200px;display: inline-block;text-align: left;color: #bd0b38;font-size: 24px;font-weight: bold;">{{dataForm.totalSAmount}}</span>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="12">
                                        <el-button :size="size" type="primary" @click.native="submitConfirmForm"
        ...
        methods: {
            ...
            handleEdit: function (params) {
                ...
                var prm = {
                    page: 1,
                    rows: 10,
                    'inDateStart': params.index.inDateStart,
                    'outDateEnd': params.index.outDateEnd,
                    'roomCode': params.index.roomCode
                };
