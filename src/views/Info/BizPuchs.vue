<template>
	...
	<kt-table permsEdit="sys:bizPuchs:edit" permsDelete="sys:bizPuchs:delete"  permsConfirm="sys:bizPuchs:confirm"
		...
		@findPage="findPage" @handleEdit="handleEdit" @handleDelete="handleDelete"  @handleConfirm=" handleConfirm">
	</kt-table>
	<!--新增编辑界面-->
	<el-dialog :title="operation?'新增':'编辑'" width="90%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
        ...
        <!--订单确定界面-->
        <el-dialog :title="operation?'订单确定':'订单确认'" width="90%" :visible.sync="confirmDialogVisible" :close-on-click-modal="false">
            <el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm"  :size="size":inline="true" label-position="left" >
            ...
            <div slot="footer" class="dialog-footer">
                <el-button :size="size" @click.native="confirmDialogVisible = false">{{$t('action.cancel')}}</el-button>
