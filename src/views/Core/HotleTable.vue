<template>
  <div class="table_room_container" style="height: auto">
    ...
    <el-table :data="data.rows" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange"
      ...
      <!--</el-table-column>-->
      <el-table-column prop="hotelCode" header-align="center" align="center" :label="$t('hotel.hotelCode')" width="130">
      </el-table-column>
      <el-table-column prop="countryCode" header-align="center"align="center" :label="$t('hotel.countryCode.countryCode')" width="130">
      </el-table-column>

        <el-table-column prop="provinceCode" header-align="center" align="center" :label="$t('hotel.provinceCode.provinceCode')" width="130">
            <template slot-scope="scope">
                <el-tag>{{resolveRoomTypeName(paraConfig.PREFECTURE,scope.row.provinceCode)}}</el-tag>
            </template>
        </el-table-column>

        <el-table-column prop="cityCode" header-align="center" align="center" :label="$t('hotel.cityCode.cityCode')" width="130">
            <template slot-scope="scope">
        ...
        <el-table-column prop="hotelType" header-align="center" align="center"
                         :label="$t('hotel.hotelType.hotelType')" width="120">
            <template slot-scope="scope">
      ...
      <!--<el-table-column prop="hotelLevel" header-align="center" align="center" :label="$t('hotel.hotelLevel.hotelLevel')">-->
        ...
        <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column :prop="language.lge=='zh_cn'?'hotelCname':'hotelEname'" header-align="center" align="center" :label="$t('hotel.hotelname')" width="170">
      </el-table-column>
      ...
      <!--</el-table-column>-->
      <el-table-column prop="hotelPhone" header-align="center" align="center" :label="$t('hotel.hotelPhone')"width="120">
      </el-table-column>
